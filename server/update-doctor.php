...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        isset($_POST['doctor_id'], $_POST['fname'], $_POST['lname'], $_POST['username'], $_POST['email'], 
        ...
        $sql = "UPDATE users SET 
                ...
                WHERE id='$doctor_id' AND usertype='2'";

        if (mysqli_query($con, $sql)) {
            $_SESSION['success'] = 'Doctor details updated successfully.';
            header('Location: ../edit-doctor.php?doctor_id=' . $doctor_id);
            exit;
        } else {
        ...
        header('Location: ../edit-doctor.php?doctor_id=' . $_POST['doctor_id']);
        exit;
    }
} else {
