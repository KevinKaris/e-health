            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Clerk</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="server/add-clerk.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit">Create Clerk</button>
                            </div>
                        </form>
                    </div>
                </div>
