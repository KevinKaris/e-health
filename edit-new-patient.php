    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="server/forward-to-pharmacist.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="analysis" rows="3" cols="30" placeholder="Analysed Problem..."></textarea>
                            </div>
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit">Forward To PHARMACIST</button>
                            </div>
                        </form>
                    </div>
                </div>
